...
from analytics.enhanced_activity_classifier import classify_activity
...
class OfflineAccuracyTester:
 ...
 print(f" Error in {scenario} frame {frame}: {e}")
 keypoint_accuracies.append(0.0)
 ...
 if not valid_ranges:
 print(f" Invalid feature ranges in {scenario} frame {frame}")
 ...
 print(" ACCEPTABLE: Needs tuning before clinical use")
 else:
