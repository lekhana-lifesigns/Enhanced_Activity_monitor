...
def benchmark_all_goals(
 ...
 print(f" IoU evaluation failed: {e}")
 results['goals']['iou'] = {
 'status': ' NOT EVALUATED',
 'error': str(e)
 }
 else:
 print(" IoU evaluation skipped (no ground truth provided)")
 results['goals']['iou'] = {
 'status': ' NOT EVALUATED',
 ...
 print(f" ID-switch evaluation failed: {e}")
 results['goals']['id_switch'] = {
 'status': ' NOT EVALUATED',
 'error': str(e)
 }
 else:
 print(" ID-switch evaluation skipped (no ground truth provided)")
 results['goals']['id_switch'] = {
 'status': ' NOT EVALUATED',
 'reason': 'No ground truth data provided'
 }
