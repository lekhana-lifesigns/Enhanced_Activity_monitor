...
def test_tracking():
 ...
 print(f" Tracking may not be working - no track IDs detected")
...
def test_reporting():
 ...
 if event_count == 0:
 print(" No events in database - cannot generate meaningful report")
...
def test_integration():
 ...
 print(" Integration may have issues - no events stored")
...
def main():
 ...
 print(f"Reporting: {' WORKING' if reporting_ok else ' ISSUES'}")
 print(f"Integration: {' WORKING' if integration_ok else ' ISSUES'}")
 print("="*70)
