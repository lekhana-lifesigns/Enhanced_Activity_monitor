...
def test_camera_zoom():
 ...
 log.warning(" Camera not available (this is OK for testing): %s", e)
...
def test_inference_pipeline_integration():
 ...
 log.warning(" Config file not found, skipping integration test")
 return True
 ...
 log.warning(" Bed detector is None (may be disabled)")
 ...
 log.warning(" Camera not available, but code structure is correct")
...
def measure_latency():
 ...
 log.warning(" Some latencies exceed 100ms threshold")
...
def main():
 ...
 log.warning("\n Some tests failed or warnings occurred.")
 return 1
